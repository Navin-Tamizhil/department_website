...
export default function PG() {
  ...
  const yearWise = {
    "First Year": syllabus.filter((sem) => sem.semester === "Semester 1" || sem.semester === "Semester 2"),
          ...
          {Object.entries(yearWise).map(([year, semesters], yIdx) => (
            <div key={yIdx} className="bg-white rounded-xl shadow-lg border border-gray-200">
              ...
              >
                ...
                {openYear === year ? <ChevronDown className="w-6 h-6 text-gray-600" /> : <ChevronRight className="w-6 h-6 text-gray-600" />}
              </button>
