...
import { ChevronDown, ChevronRight, BookOpen, Calendar, FileText, Clock, Users } from "lucide-react";
      ...
      <div className="mb-8">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-indigo-100">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Develop a foundation for Biotechnology and Bioinformatics in young minds and inculcate interest
            by showing real-life challenges that can be addressed by biotechnology and bioinformatics. 
            First course among all IITs with equal emphasis on experimental and computational aspects.
          </p>
                              ...
                              <thead>
                                <tr className="bg-gray-100">
                                  {Object.keys(sem.data[0] || {}).map((key) => (
                                    <th key={key} className="px-3 py-2 text-left font-medium text-gray-700 border border-gray-200">
                                      {key}
                                    </th>
                                  ))}
                                </tr>
